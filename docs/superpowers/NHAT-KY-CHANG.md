...
> ## ĐÂY LÀ NHẬT KÝ, KHÔNG PHẢI BÀN GIAO
>
> File này từng tên `HANDOFF.md`. Tới 2026-08-29 nó dài 4.056 dòng / 42 mục, và **gần như toàn bộ
> là chặng ĐÃ XONG** — thứ cần đọc để bắt đầu làm việc (còn nợ gì, luật thao tác nào đã trả giá,
> cổng kiểm chạy ra sao) bị chôn giữa hàng nghìn dòng hồ sơ. Nên phần bàn giao đã tách sang
> **[`HANDOFF.md`](HANDOFF.md)** — đọc file đó trước.
>
> Giữ nguyên vẹn file này thay vì xoá: mỗi mục ghi cả những đường ĐÃ THỬ VÀ HỎNG kèm phép đo loại
> trừ chúng. Đó là thứ ngăn lượt sau đi lại đúng con đường cụt — giá trị nằm ở chỗ nó dài.
>
> Tra ở đây khi cần **vì sao** một quyết định được đưa ra, hoặc khi định thử lại một hướng nghe có
> vẻ hay: rất có thể nó đã được thử rồi. Trạng thái "đang mở" thì luôn đọc ở `HANDOFF.md`, không
> đọc ở đây — mọi dòng dưới đây là ảnh chụp tại thời điểm viết, và **một danh sách nợ không tự già
> đi cùng mã nguồn** (bài học mục 39.1).
