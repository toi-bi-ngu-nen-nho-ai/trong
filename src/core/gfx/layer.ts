...
import type { GfxController } from './index';
import {
...
import { GfxPrimitiveElementModel } from './model/surface/element-model';
import { GfxLocalElementModel } from './model/surface/local-element-model';
import { SurfaceBlockModel } from './model/surface/surface-model';
