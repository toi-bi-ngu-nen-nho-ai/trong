...
import type { TestShapeElement } from './fixtures/test-gfx-element';
import {
...
// Bản gốc gọi `effects()` ở đây. Bỏ đi: hàm đó chỉ đăng ký custom element của Lit
// (`editor-host`, `gfx-viewport`, `v-element`, `v-line`, `v-text`) — không ca nào trong file
// này chạm tới chúng. Đây là lý do phần hành vi của surface.unit.spec.ts port được, trái với
// điều spec §10 khẳng định về "nhóm C".
